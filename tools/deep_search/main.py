...
def deep_search(query: str) -> str:
    """Performs an expansive, parallel deep web search to thoroughly answer complex queries."""
    urls = []
    ...
    # Remove duplicate URLs while preserving order, limit to top 4
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=4) as executor:
        futures = [executor.submit(fetch_and_summarize, url, query) for url in urls]
